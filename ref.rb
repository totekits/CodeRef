...
grade = "C"
case grade
in "A" then puts "Amazing!"
in "B" then puts "Well done!"
in "C" then puts "Good!"
in "D" then puts "Ok!"
else puts "Do you need help?"
end
#=> Well done!
...
in String then puts "input in of type String"
end
#=> input is of type Integer

  # the following literal types can do pattern matching:
  # Booleans, Nil, Numbers, Strings, Symbols, Arrays, Hashes, Ranges, Regexp, Procs
